//! Specifications for Tag aggregate
//!
...
// Each predicate implements `Specification<Tag>` and can be combined
...
//
// pub struct ActiveTagSpec;
// impl Specification<Tag> for ActiveTagSpec {
//     fn is_satisfied_by(&self, e: &Tag) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
