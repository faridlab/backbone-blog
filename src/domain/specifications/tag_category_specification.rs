//! Specifications for TagCategory aggregate
//!
...
// Each predicate implements `Specification<TagCategory>` and can be combined
...
//
// pub struct ActiveTagCategorySpec;
// impl Specification<TagCategory> for ActiveTagCategorySpec {
//     fn is_satisfied_by(&self, e: &TagCategory) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
