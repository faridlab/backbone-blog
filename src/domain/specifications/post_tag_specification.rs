//! Specifications for PostTag aggregate
//!
...
// Each predicate implements `Specification<PostTag>` and can be combined
...
//
// pub struct ActivePostTagSpec;
// impl Specification<PostTag> for ActivePostTagSpec {
//     fn is_satisfied_by(&self, e: &PostTag) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
