//! Specifications for BlogAuditLog aggregate
//!
...
// Each predicate implements `Specification<BlogAuditLog>` and can be combined
...
//
// pub struct ActiveBlogAuditLogSpec;
// impl Specification<BlogAuditLog> for ActiveBlogAuditLogSpec {
//     fn is_satisfied_by(&self, e: &BlogAuditLog) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
