//! Specifications for Post aggregate
//!
...
// Each predicate implements `Specification<Post>` and can be combined
...
//
// pub struct ActivePostSpec;
// impl Specification<Post> for ActivePostSpec {
//     fn is_satisfied_by(&self, e: &Post) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
