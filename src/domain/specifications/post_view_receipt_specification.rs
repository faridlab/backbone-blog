//! Specifications for PostViewReceipt aggregate
//!
...
// Each predicate implements `Specification<PostViewReceipt>` and can be combined
...
//
// pub struct ActivePostViewReceiptSpec;
// impl Specification<PostViewReceipt> for ActivePostViewReceiptSpec {
//     fn is_satisfied_by(&self, e: &PostViewReceipt) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
