//! Domain policy for TagCategory aggregate
//!
...
/// Domain policy for TagCategory — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<TagCategory>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type TagCategoryDomainPolicy = PermitAllPolicy<TagCategory>;
