//! Domain policy for PostViewReceipt aggregate
//!
...
/// Domain policy for PostViewReceipt — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PostViewReceipt>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PostViewReceiptDomainPolicy = PermitAllPolicy<PostViewReceipt>;
