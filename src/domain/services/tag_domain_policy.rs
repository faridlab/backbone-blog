//! Domain policy for Tag aggregate
//!
...
/// Domain policy for Tag — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Tag>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type TagDomainPolicy = PermitAllPolicy<Tag>;
