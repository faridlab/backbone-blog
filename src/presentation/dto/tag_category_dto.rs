//! TagCategory DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new TagCategory
///
...
/// Request DTO for full update of a TagCategory
///
...
/// Request DTO for partial update of a TagCategory
///
...
/// Response DTO for TagCategory entity
///
...
/// Paginated list response for TagCategory entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct TagCategoryListResponseDto {
    /// List of items
    pub items: Vec<TagCategoryResponseDto>,
...
impl TagCategoryListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<TagCategoryResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<TagCategory> for TagCategoryResponseDto {
...
impl From<TagCategory> for TagCategorySummaryDto {
    fn from(entity: TagCategory) -> Self {
...
impl From<CreateTagCategoryDto> for TagCategory {
...
impl backbone_core::FromCreateDto<CreateTagCategoryDto> for TagCategory {
    fn from_create_dto(dto: CreateTagCategoryDto) -> backbone_core::ServiceResult<Self> {
        Ok(TagCategory::from(dto))
    }
}
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to TagCategory here.
