//! BlogAuditLog DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new BlogAuditLog
///
...
/// Request DTO for full update of a BlogAuditLog
///
...
/// Request DTO for partial update of a BlogAuditLog
///
...
/// Response DTO for BlogAuditLog entity
///
...
/// Paginated list response for BlogAuditLog entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct BlogAuditLogListResponseDto {
    /// List of items
    pub items: Vec<BlogAuditLogResponseDto>,
...
impl BlogAuditLogListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<BlogAuditLogResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<BlogAuditLog> for BlogAuditLogResponseDto {
...
impl From<BlogAuditLog> for BlogAuditLogSummaryDto {
    fn from(entity: BlogAuditLog) -> Self {
...
impl From<CreateBlogAuditLogDto> for BlogAuditLog {
...
impl backbone_core::FromCreateDto<CreateBlogAuditLogDto> for BlogAuditLog {
    fn from_create_dto(dto: CreateBlogAuditLogDto) -> backbone_core::ServiceResult<Self> {
        Ok(BlogAuditLog::from(dto))
    }
}
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to BlogAuditLog here.
